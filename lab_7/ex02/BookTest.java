...
public class BookTest {
    public static void main(String[] args) {
        ...
        LibraryBook book2;/*
                           * = new LibraryBook("None", deitel, "None", "unknown order");
                           * book1 = book2;
                           * out.printf("Book 2: %s\n", book1);
                           * book2.checkout("","");
                           * book2.returned();
        ...
        book2 = new ReferenceBook("Software Enginnering", summerville, "0-87626-717-7", "100.100",
        ...
        book2 = new CirculatingBook("Pascal:  Problem Solving and Structured Program Design", walker, "0-316-91848-2",
                "100.200");
        book1 = book2;
